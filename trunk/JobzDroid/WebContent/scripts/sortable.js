...
function sortables_init() {
	...
	for (ti=0;ti<tbls.length;ti++) {
		thisTbl = tbls[ti];
		if (((' '+thisTbl.className+' ').indexOf("sortable") != -1) && (thisTbl.id)=="sortableSearcher") {
			ts_makeSortable(thisTbl);
		}
		else if (((' '+thisTbl.className+' ').indexOf("sortable") != -1) && (thisTbl.id)=="sortableJobAd") {
			ts_makeSortable2(thisTbl);
		}
		else if (((' '+thisTbl.className+' ').indexOf("sortable") != -1) && (thisTbl.id)=="sortableMyAds") {
			ts_makeSortable3(thisTbl);
		}
		else if (((' '+thisTbl.className+' ').indexOf("sortable") != -1) && (thisTbl.id)=="sortableJobFeeds") {
			ts_makeSortable4(thisTbl);
		}
	}
}
